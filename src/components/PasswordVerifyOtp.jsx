...
const PasswordVerifyOTP = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_SERVER_URL}user/password-verify-otp`, { otp: finalOTP, emailForVerification: verificationEmail }, {withCredentials: true});
