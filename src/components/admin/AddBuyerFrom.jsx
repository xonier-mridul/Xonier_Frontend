            ...
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                ...
                <div className="p-5 rounded-lg bg-stone-50 grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <input type="text" name="name" className="w-full border-1 bg-white border-zinc-200 outline-none p-3 rounded-lg" value={formData.name} onChange={handleChange} placeholder="Name"/>
                    </div>
                    
                    <div className="flex flex-col gap-2">
                        <label htmlFor="email" className="text-lg">Email</label>
                        <input type="email" name="email" className="w-full border-1 bg-white border-zinc-200 outline-none p-3 rounded-lg" value={formData.email} onChange={handleChange} placeholder="Email"/>
                    </div>
                    <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2 col-span-2">
                        ...
                        {showPassword ? <div className="flex items-center bg-white w-full border-1 border-zinc-200  p-3 rounded-lg"> <input type="text" name="password" className="w-full outline-none" value={formData.password} onChange={handleChange} placeholder="Password"/> <span className="cursor-pointer  hover:text-green-500 transition-all duration-300 hover:scale-110" onClick={()=>setShowPassword(false)}>< FaEyeSlash/></span>  </div> : <div className="flex items-center bg-white w-full border-1 border-zinc-200 outline-none p-3 rounded-lg"> <input type="password" name="password" className="w-full outline-none" value={formData.password} onChange={handleChange} placeholder="Password"/> <span className="cursor-pointer hover:text-green-500 transition-all duration-300 hover:scale-110" onClick={()=>setShowPassword(true)}>< FaEye/></span> </div> }
                    </div>
                </div>
                 <div className="font-semibold text-2xl"><span className="text-red-500">*</span>Company Details</div>
                <div className="grid grid-cols-2 gap-4 p-5 rounded-lg bg-stone-50">
                    <div className="flex flex-col gap-2">
                        <label htmlFor="company" className="text-lg">Company Name</label>
                        <input type="text" name="company" className="w-full border-1 border-zinc-200 bg-white outline-none p-3 rounded-lg" value={formData.company} onChange={handleChange} placeholder="Company Name"/>
                    </div>
                    <div className="flex flex-col gap-2">
                        <label htmlFor="tradeNumber" className="text-lg">Trade Number</label>
                        <input type="text" name="tradeNumber" className="w-full border-1 bg-white border-zinc-200 outline-none p-3 rounded-lg" value={formData.tradeNumber} onChange={handleChange} placeholder="Trade Number"/>
                    </div>
                    <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input type="text" name="companyGSTNumber" className="w-full border-1 bg-white border-zinc-200 outline-none p-3 rounded-lg" value={formData.companyGSTNumber} onChange={handleChange} placeholder="Company GST Number"/>
                    </div>
                    <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-end">
                    <button type="submit" className="bg-teal-600 text-white px-6 py-2.5 rounded-lg tracking-wide hover:bg-teal-700 hover:scale-105 transition-all duration-300 cursor-pointer flex gap-2 items-center" >{ isLoading ? "Submitting..." : "Submit"} <FaArrowRight /></button>
                </div>
            </form>
        </div>
      </div>
