  ...
  return (
    ...
    <>
      ...
      <div className='fixed w-[520px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-8 flex flex-col gap-4 rounded-lg bg-white z-[100] shadow-[0_0_20px_#00000020]'>
         <span className='absolute right-3 top-3 text-2xl' onClick={logoutShow}><FaXmark /></span>
         ...
         <button className='bg-emerald-500 px-4 py-2 rounded-lg text-white' type='button' onClick={logout}>Logout</button>
      </div>
    </> 
